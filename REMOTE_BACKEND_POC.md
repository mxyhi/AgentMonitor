...
This fork includes a **proof-of-concept** daemon that runs Agent Monitor's backend logic in a separate process (intended for WSL2/Linux), exposing a simple **line-delimited JSON-RPC** protocol over TCP.

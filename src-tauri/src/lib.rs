...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            codex::update_global_ai_session_defaults,
            codex::update_openai_base_url,
            codex::create_custom_ai_provider,
            codex::update_custom_ai_provider,
            codex::delete_custom_ai_provider,

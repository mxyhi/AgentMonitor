...
export function MobileRemoteWorkspacePrompt({
  ...
  return (
    <ModalShell
      ariaLabel={m.mobile_remote_workspace_aria({}, { locale })}
    ...
    >
      <div className="mobile-remote-workspace-modal-content">
        <div className="ds-modal-title">{m.mobile_remote_workspace_title({}, { locale })}</div>
        <div className="ds-modal-subtitle">
          {m.mobile_remote_workspace_subtitle({}, { locale })}
        </div>
        <label className="ds-modal-label" htmlFor="mobile-remote-workspace-paths">
          {m.mobile_remote_workspace_paths({}, { locale })}
        </label>
        <textarea
